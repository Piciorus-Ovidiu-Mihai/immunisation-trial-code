...
namespace ClinicalSurveyApp.Controllers
{
    ...
    public class ManageUsersController : Controller
    {
        ...
        public ManageUsersController(RoleManager<IdentityRole> roleManager,
        ...
        public async Task<IActionResult> Details()
        {
            ...
            var model = new ViewSingleUserViewModel();
        ...
        public async Task<IActionResult> Edit(UserDetailsViewModel model)
        {
            ...
            {
                ApplicationUser user = _userManager.Users.FirstOrDefault(u => u.Id == model.Id);
